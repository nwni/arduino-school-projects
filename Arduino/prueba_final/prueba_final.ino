//VUELTA IZQ SOBRE EL PROPIO EJE
...
void loop() {
  ...
  if (distance2 < 6 && (distance > 2)) {
//    for (int j = 0; j < 16; j++) {
//      frontMovement();
//    }
//GIRA SOLO LA LLANTA IZQUIERDA!!!
 //   for (int i = 0; i < 300; i++) {
   //   girarIzquierdaPropioEje();
   // }
//GIRA AMBAS EN SENTIDO CONTRARIO!!!  //150  
        for (int i = 0; i < 75; i++) {
      girarIzquierdaPropioEje();
    }
