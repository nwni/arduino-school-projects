...
void setup()   /****** SETUP: RUNS ONCE ******/
{
  ...
  stepper1.moveTo(-22048);  // 1 revolution; una vuelta
  
  stepper2.setMaxSpeed(300.0);
  stepper2.setAcceleration(50.0);
  stepper2.setSpeed(200);
  stepper2.moveTo(22048);  // 1 revolution 
...
//    stepper1.moveTo(stepper1.currentPosition());
//    stepper2.moveTo(-stepper2.currentPosition());
 // stepper1.moveTo(-2048);  // 1 revolution; una vuelta
  //stepper2.moveTo(2048);  // 1 revolution; una vuelta
  stepper1.run();
  stepper2.run();
  //delay(1000);
